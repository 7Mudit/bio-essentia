...
const Product = ({
  ...
  return (
    <div className="rounded-[22px] border-[2px] duration-300 transition-all hover:scale-95 flex flex-col gap-3 max-w-sm p-4 min-h-[550px] items-start justify-between sm:p-10 relative bg-white dark:bg-zinc-900">
      {hot && (
